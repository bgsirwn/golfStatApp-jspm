...
//        var _self = this;       
    ...
    changeLanguage() {
        ...
        this.i18n
            ...
            .then( () => {
                console.log("locale set to : "+this.i18n.getLocale()+"penalty translation is : "+this.i18n.tr('penalty'));
                _self.pouch.saveDoc(this.config);
                _self.f7.alert(this.i18n.tr('langAdapted'), 'Confirmation');
        });
    }
}
